...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { destination_aptour_id: @destination.destination_aptour_id, name: @destination.name }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { destination_aptour_id: @destination.destination_aptour_id, name: @destination.name }
    assert_redirected_to destination_path(assigns(:destination))
  end
